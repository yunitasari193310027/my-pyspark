...
# Read SUB_DIM
df_SUB = hv.table('base.subs_dim').select('subs_id','msisdn','price_plan_id','area_hlr','region_hlr','cust_type_desc','cust_subtype_desc','customer_sub_segment','city_hlr').show()

# PROCESSING
df_PAYR = hv.table('base.source_payr')\
        ...
        .write.csv("file:///home/hdoop/BelajarPyspark/hasilSA_Payr_Part1_minimalisir_hive", sep ='~')
