...
         .toDF('trx_date','subs_id_mtd','lacci_id_mtd','msisdn','cust_type_desc','cust_subtype_desc','area_sales','region_sales','branch','subbranch','cluster_sales','provinsi','kabupaten','kecamatan','kelurahan','node_type','vol','trx','dur','load_ts','load_user','job_id')\
         .dropDuplicates(['subs_id_mtd'])\
         .select('subs_id_mtd','lacci_id_mtd')

# READ DATA MM
df_MM = spark.read.parquet("file:///home/hdoop/datayunita/dom_mm")\
        .toDF('trx_date','subs_id_mm','lacci_id_mm','msisdn','cust_type_desc','cust_subtype_desc','area_sales','region_sales','branch','subbranch','cluster_sales','provinsi','kabupaten','kecamatan','kelurahan','node_type','vol','trx','dur','load_ts','load_user','job_id')\
        .dropDuplicates(['subs_id_mm'])\
        .select('subs_id_mm','lacci_id_mm')
...
# PROCCESING
dfPAYR_Part2 = spark.read.csv("file:///home/hdoop/BelajarPyspark/hasilSA_Payr_Part1", sep ='~', header = False)\
